package com.example.newlab66.controller;

import com.example.newlab66.pojo.Wizard;
import com.example.newlab66.pojo.Wizards;
import com.example.newlab66.repository.WizardService;
...
public class WizardController {
    ...
    public boolean updateWizard(@RequestBody MultiValueMap<String, String> n) {
        Map<String, String> d = n.toSingleValueMap();
        List<Wizard> wizard =  wizardService.updateWizard(new Wizard(d.get("_id"),d.get("sex"),d.get("name"),d.get("school"),d.get("house"),Integer.parseInt(d.get("money")),d.get("position")));
        return true;
    }
